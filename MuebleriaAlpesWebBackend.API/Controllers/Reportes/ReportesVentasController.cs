...
namespace MuebleriaAlpesWebBackend.API.Controllers.Reportes
{
    [ApiController]
    ...
    public class ReportesVentasController : ControllerBase
    {
        ...
        [HttpGet("filtros/canales-venta")]
        public async Task<IActionResult> ListarCanalesVentaFiltro()
        {
            try
            {
                var response = await _reportesVentasService.ListarCanalesVentaFiltroAsync();
                return Ok(new { success = true, data = response });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> ListarCiudadesFiltro()
        {
            try
            {
                var response = await _reportesVentasService.ListarCiudadesFiltroAsync();
                return Ok(new { success = true, data = response });
            }
            catch (Exception ex)
            {
