...
namespace MuebleriaAlpesWebBackend.API.Controllers.Envios
{
    [ApiController]
    ...
    public class EnviosController : ControllerBase
    {
        ...
        [HttpGet("filtros/ordenes-disponibles")]
        public async Task<IActionResult> ListarOrdenesDisponiblesFiltro()
        {
            try
            {
                var response = await _enviosService.ListarOrdenesDisponiblesFiltroAsync();
        ...
        [HttpGet("filtros/direcciones-cliente/{clienteId:int}")]
        public async Task<IActionResult> ListarDireccionesClienteFiltro(int clienteId)
        {
            try
            {
                var response = await _enviosService.ListarDireccionesClienteFiltroAsync(clienteId);
                return Ok(new { success = true, data = response });
            }
            catch (Exception ex)
            {
